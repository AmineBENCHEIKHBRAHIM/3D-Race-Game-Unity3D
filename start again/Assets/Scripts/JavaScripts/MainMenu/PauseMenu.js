...
var credits:String[]=[
	"An ENSI Gamers Production",
	"Programming by Amine && Rihab ",
	"Game Design by Amine & Rihab Designs",
	"Copyright (c) 2013-2014 "] ;
var crediticons:Texture[];
 
enum Page {
	None,Main,Options,Credits,ToMenu
}
...
function OnGUI () {
	...
	if (IsGamePaused()) {
		...
		switch (currentPage) {
			...
			case Page.ToMenu: Application.LoadLevel(0); break;
		}
	}	
}
...
function IsLegal() {
	return !IsBrowser() || 
	Application.absoluteURL.StartsWith("http://www.ensigames.com/") ||
	Application.absoluteURL.StartsWith("http://ensigames.com/");
}
