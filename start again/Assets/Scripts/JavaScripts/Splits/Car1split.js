...
{		
	...
	if(Timer1split.isFinished1==false)
	GetInput();
	else {throttle=0.0;dragMultiplier.x = initialDragMultiplierX * handbrakeXDragFactor;}
...
{	
	...
	currentSpeed = (Mathf.PI*2*myWC.radius)*myWC.rpm*60/1000;
	currentSpeed = Mathf.Round(currentSpeed);
	GuiSpeed.text = "Current speed \n" + currentSpeed.ToString(); 
}
